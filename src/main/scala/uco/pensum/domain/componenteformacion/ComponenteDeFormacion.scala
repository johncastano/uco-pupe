...
import uco.pensum.infrastructure.http.dtos.ComponenteDeFormacioAsignacion
...
object ComponenteDeFormacion{
  def validar(dto: ComponenteDeFormacioAsignacion): Either[DomainError, ComponenteDeFormacion] = for{
